...
**1) Moving if condition and switch case into lookup table(1D array) by this cyclomatic complexity Reduced**
**2) Parameter implementation by this extension are easy for upcoming implementation**
